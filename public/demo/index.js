(function (three) {
  ...
  var DeltaControlsDemo = function (_Demo) {
    _inherits(DeltaControlsDemo, _Demo);

    function DeltaControlsDemo() {
      var _this;

      _classCallCheck(this, DeltaControlsDemo);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(DeltaControlsDemo).call(this, "delta-controls"));
      _this.mesh = null;
      return _this;
    }

    _createClass(DeltaControlsDemo, [{
      key: "load",
      value: function load() {
      ...
      value: function render(delta) {
        ...
        _get(_getPrototypeOf(DeltaControlsDemo.prototype), "render", this).call(this, delta);
      }
    }, {
      key: "registerOptions",
      value: function registerOptions(menu) {
