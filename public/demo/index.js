(function (three,dat,Stats) {
  ...
  var DeltaControlsDemo = function (_Demo) {
  		inherits(DeltaControlsDemo, _Demo);

  		function DeltaControlsDemo() {
  				classCallCheck(this, DeltaControlsDemo);

  				var _this = possibleConstructorReturn(this, (DeltaControlsDemo.__proto__ || Object.getPrototypeOf(DeltaControlsDemo)).call(this, "delta-controls"));
  		...
  		createClass(DeltaControlsDemo, [{
  				...
  				value: function initialize() {
  						...
  						var mesh = new three.Mesh(new three.SphereBufferGeometry(0.05, 16, 16), new three.MeshBasicMaterial({
  								transparent: true,
  								wireframe: true,
  								opacity: 0.35,
  								color: 0xff9600,
  				...
  				value: function render(delta) {
  						...
  						get(DeltaControlsDemo.prototype.__proto__ || Object.getPrototypeOf(DeltaControlsDemo.prototype), "render", this).call(this, delta);
  				}
  		}, {
  				key: "registerOptions",
  				value: function registerOptions(menu) {
  						...
  						var folder = menu.addFolder("General");
  						folder.add(params, "orbit").onChange(function () {
